...
d_G_by_rbm_w=d_G_by_rbm_w+hidden_state(:,i)*visible_state(:,i)';
end
% G=sum(diag(hidden_state'*rbm_w*visible_state))/size(visible_state,2);
             d_G_by_rbm_w=d_G_by_rbm_w/size(visible_state,2);
end
